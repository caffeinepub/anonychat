        ...
        {phase === "idle" && (
          ...
          >
            <div className="text-center space-y-4 max-w-xs">
              ...
              <div className="flex justify-center gap-4 text-xs text-muted-foreground">
                {["Anonymous", "Instant", "Voice"].map((label) => (
                  <span
                    key={label}
                    className="px-2 py-1 rounded-full bg-muted/30 border border-border"
                  >
                    {label}
                  </span>
                ))}
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-muted/30 border border-border text-sm text-muted-foreground hover:text-foreground hover:border-white/20 transition-all"
        ...
        {phase === "waiting" && (
          ...
          >
            ...
            <Button
              ...
              className="text-muted-foreground hover:text-foreground border border-border hover:bg-muted/30"
            >
              Cancel
            </Button>
          </motion.div>
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-border flex-shrink-0">
              <div className="flex items-center gap-3">
                ...
                <span className="w-2 h-2 rounded-full bg-[oklch(0.72_0.18_145)] inline-block ml-1" />
              </div>
              <Button
                variant="ghost"
                size="sm"
                ...
                className="text-muted-foreground hover:text-red-400 border border-border hover:border-red-400/30 hover:bg-red-400/5 text-xs"
              >
                Disconnect
              </Button>
            </div>
                        ...
                        <div
                          className={`max-w-[72%] px-3.5 py-2 rounded-2xl text-sm leading-relaxed ${
                            isOwn
                              ...
                              : "bubble-received text-foreground rounded-bl-sm border border-border/50"
                          }`}
                        >
                          {msg.content}
                        </div>
                      ...
                      <div
                        className={`px-3 py-2 rounded-2xl ${
                          isOwn
                            ...
                            : "bubble-received rounded-bl-sm border border-border/50"
                        }`}
                      >
                        <VoiceMessagePlayer
              ...
              {showVoiceRecorder ? (
                ...
                <>
                  <input
                    ...
                    className="flex-1 bg-muted/30 border border-border rounded-xl px-4 py-2.5 text-sm outline-none focus:border-primary/40 placeholder:text-muted-foreground/50 transition-colors disabled:opacity-50"
                  />
                  <Button
                    size="sm"
                    variant="ghost"
                    ...
                    className="border border-border hover:bg-primary/10 hover:border-primary/30 hover:text-primary text-muted-foreground rounded-xl px-3 py-2.5 h-auto shrink-0"
                  >
